 ...
 * up-inflection (perfect-fifth climb), so it clearly stands apart from the
 * completion / resume / repo / open-mic / voice-command sounds and reads as
...
export function playQuestionSound(): void {
  try {
    ...
    // Rising fifth E5 -> B5 — an interrogative "ba-ding?"
